...
export const PlasmicHomepage__ArgProps = new Array("frame132");
        ...
        >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {false ? (
                        <ChevronDownIcon
                          className={classNames(projectcss.all, sty.svg__zYcB)}
                          role={"img"}
                        />
                      ) : null}
                    </p.Stack>
          ...
          >
            ...
            <p.PlasmicImg
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/blank_project/images/dropdownHeaderNavigation.svg",
                fullWidth: 1440,
                fullHeight: 1,
                aspectRatio: 1440
              }}
          ...
          >
                ...
                >
                  ...
                  >
                    <React.Fragment>
                      ...
                      <React.Fragment>
                        {
                          " currently practicing while learning User\rExperience Design & Writing. Digitalent Skilvul UI/UX design student "
                        }
                      </React.Fragment>
                    </React.Fragment>
                  </div>
            ...
            >
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse6.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse3.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse1.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse5.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse4.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              >
                <p.PlasmicImg
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/plasmic/blank_project/images/circleDown.svg",
                    fullWidth: 36,
                    fullHeight: 36,
                    aspectRatio: 1
                  }}
                              ...
                              defaultContents: (
                                <React.Fragment>
                                  <Heading1CoCreateRevampHome
                                    className={classNames(
                                      "__wab_instance",
                                      sty.heading1CoCreateRevampHome___0FFv3
                                    )}
                                  />
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {
                                "This project is done, it just hasn’t uploaded yet"
                              }
                            </div>
                          </p.Stack>
                        </div>
            ...
            >
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse9.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/letter.svg",
                  fullWidth: 575,
                  fullHeight: 512,
              ...
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/blank_project/images/ellipse10.svg",
                  fullWidth: 1226,
                  fullHeight: 1226,
                  aspectRatio: 1
                }}
              ...
              >
                <p.PlasmicImg
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/plasmic/blank_project/images/vector4.svg",
                    fullWidth: 380,
                    fullHeight: 248,
                ...
                <p.PlasmicImg
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/plasmic/blank_project/images/vector8.svg",
                    fullWidth: 39,
                    fullHeight: 40,
                    aspectRatio: 0.975
                  }}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {
                      "Thank you for reading my portfolio. The image and picture in the case study belongs to respective owners.\nEverything of the work in this document is genuine and subjected to copyright. Please contact me for a further portfolio."
                    }
                  </div>
                </p.Stack>
              </p.Stack>
...
const PlasmicDescendants = {
  ...
  button2: ["button2", "buttonBase2", "text2"],
  buttonBase2: ["buttonBase2", "text2"],
  text2: ["text2"],
  dropdownHeaderNavigationTrigger2: [
    "dropdownHeaderNavigationTrigger2",
    "button3",
  ...
  text3: ["text3"],
  button4: ["button4", "buttonBase4", "text4"],
  ...
  frame133: ["frame133", "author", "frame132"],
  author: ["author"],
  frame132: ["frame132"],
  categories: [
    "categories",
